...
const TileHeader = () => {
	return (
		<section class='tile-container-section'>
			...
			<section class='tile-container-column'>
				<div class='tile-container-wrapper'>
					<div class='welcome-message-banner'>
						<div class='welcome-message-wrapper'>
							<h1 class='banner'>See the world for less</h1>
							<h2></h2>
						</div>
					</div>
					<div class='booking-box box'>
						<div class='tabs-container'>
							<ul role='tablist' class='box tablist'>
								<li id='tab-all-rooms' role='tab' tabindex='0' dataselected='true' class='box link-component-container'>
									<div class='link-component-label'>
										<div class='kite-box box'>
											<svg
											class='link-component-img'
											role='img' 
											...
											<h6 class='kite-box-typography'>Hotels</h6>
										</div>
										<div class='link-component-underline box'>
										</div>
									</div>
								</li>
								<li id='tab-home' role='tab' tabindex='0' dataselected='true' class='box link-component-container'>
									<div class='link-component-label'>
										<div class='kite-box box'>
											<svg
											class='link-component-img'
											...
											<h6 class='kite-box-typography'>Homes & Apts</h6>
										</div>
										<div class='link-component-underline box'>
										</div>
									</div>
								</li>
								<li id='tab-packages-tab' role='tab' tabindex='0' dataselected='true' class='box link-component-container'>
									<div class='link-component-label'>
										<div class='kite-box box'>
											<svg
											class='link-component-img'
											...
											<h6 class='kite-box-typography'>Flight + Hotel</h6>
										</div>
										<div class='link-component-underline box'>
										</div>
									</div>
								</li>
								<li id='tab-flight-tab' role='tab' tabindex='0' dataselected='true' class='box link-component-container'>
									<div class='link-component-label'>
										<div class='kite-box box'>
											<svg
											class='link-component-img'
											...
											<h6 class='kite-box-typography'>Flights</h6>
										</div>
										<div class='link-component-underline box'>
										</div>
									</div>
								</li>
								<li id='tab-activities-tab' role='tab' tabindex='0' dataselected='true' class='box link-component-container'>
									<div class='link-component-label'>
										<div class='kite-box box'>
											<svg 
											class='link-component-img'
											...
											<h6 class='kite-box-typography'>Activities</h6>
										</div>
										<div class='link-component-underline box'>
										</div>
									</div>
								</li>
								<li id='tab-journey-tab' role='tab' tabindex='0' dataselected='true' class='box link-component-container'>
									<div class='link-component-label'>
										<div class='kite-box box'>
											<svg
											class='link-component-img'
											...
											<h6 class='kite-box-typography'>Airport transfer</h6>
										</div>
										<div class='link-component-underline box'>
										</div>
									</div>
